...
CineFlow is an enterprise-grade autonomous multi-agent film studio built for the **Agentic Cinema Hackathon**. The system translates natural-language directional vision into production-ready animatic sequences, character sheets, scored soundtracks, and synchronized dialogue.
