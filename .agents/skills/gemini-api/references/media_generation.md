...
```python
prompt = (
    "The suitcase stands up, unzips, and colorful travel stickers pop out around it."
)
...
interaction = client.interactions.create(
    ...
    input=[
        {"type": "text", "text": prompt},
        {
            "type": "image",
            "mime_type": "image/png",
            "uri": "gs://cloud-samples-data/generative-ai/image/chair-cat.png",
        },
        {
            "type": "video",
            "mime_type": "video/mp4",
...
turn2_input = interaction1.steps + [
    {
        "type": "user_input",
        "content": [
            {"type": "text", "text": "Now make the same video in a doodle style."}
        ],
    }
]
